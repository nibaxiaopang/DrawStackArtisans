...
class DrawGameOneViewController: UIViewController, DrawPopUpDelegate {
    ...
    var gameState = false
    var imgToFind = ""
    var imagesLabel = ["K♠️", "K♣️", "K♥️", "K♦️", "A♠️", "A♣️", "A♥️", "A♦️"]
    ...
    lazy var popUpWindow: DrawPopUpWindow = {
        let view = DrawPopUpWindow()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.layer.cornerRadius = 5
        view.delegate = self as DrawPopUpDelegate
        return view
    }()
