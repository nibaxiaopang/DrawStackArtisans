...
class DrawFeedbackViewController: UIViewController {
    ...
    @IBAction func btnSubmit(_ sender: Any) {
        ...
        if isStarSelected {
            clearAllStars()
            DrawAlertUtils.showAlert(title: "Thanks for feedback", message: "Your feedback added successfully", from: self)
        } else {
            DrawAlertUtils.showAlert(title: "No Selection", message: "Please select a rating before submitting.", from: self)
        }
    }
